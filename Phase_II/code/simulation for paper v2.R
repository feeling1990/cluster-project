...
simulation1_1=function(n){
  ...
  z1=c(z11,z12)
  z21=t(rmultinom(n1,size=1,prob=c(0.7,0.2,0.2))); z21=charmap(z21,char=c("a","b","c"))
  z22=t(rmultinom(n2,size=1,prob=c(0.2,0.4,0.5))); z22=charmap(z22,char=c("a","b","c"))
  z2=c(z21,z22)
  z31=t(rmultinom(n,size=1,prob=c(1/3,1/3,1/3))); z3=charmap(z31,char=c("a","b","c"))
  z41=t( rmultinom(n,size=1,prob=c(1/4,1/4,1/4,1/4)));z4=charmap(z41,char=c("a","b","c","d"))
  #z51=t( rmultinom(n,size=1,prob=c(1/5,1/5,1/5,1/5,1/5)));z5=charmap(z51,char=c("a","b","c","d","e"))
  z51=t( rmultinom(n,size=1,prob=c(1/10,1/10,1/10,1/10,1/10,1/10,1/10,1/10,1/10,1/10)));z5=charmap(z51,char=c("a","b","c","d","e","f","g","h","i","j"))
...
########Simulation Exp 1. test classical LCA on the simulated data
##run ECSM classical LCA first "ECSM classical LCA.R"
xx=X1;xx_new=xx;K=2
x=xx[,1:(c+b)]
...
for(h in 1:20){
  ...
  gammaKn = Estep(c,b,m,s,cat,xx_new,K, v[[1]], v[[2]], v[[3]],v[[4]],v[[5]]); 
}
mylabel=classassign(t(gammaKn))
confusion=table(truelabel,mylabel)
confusion
